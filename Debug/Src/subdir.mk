...
OBJS += \
./Src/TP1_ex3_student.o \
./Src/syscalls.o \
./Src/sysmem.o 

S_DEPS += \
./Src/TP1_ex3_student.d 
...
Src/TP1_ex3_student.o: ../Src/TP1_ex3_student.s
	arm-none-eabi-gcc -mcpu=cortex-m4 -g3 -c -x assembler-with-cpp -MMD -MP -MF"Src/TP1_ex3_student.d" -MT"$@" --specs=nano.specs -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -o "$@" "$<"
