...
C_SRCS += \
../Src/TP1_ex4_student.c \
../Src/syscalls.c \
../Src/sysmem.c 

OBJS += \
./Src/TP1_ex4_student.o \
./Src/syscalls.o \
./Src/sysmem.o 

C_DEPS += \
./Src/TP1_ex4_student.d \
./Src/syscalls.d \
./Src/sysmem.d 


# Each subdirectory must supply rules for building sources it contributes
Src/TP1_ex4_student.o: ../Src/TP1_ex4_student.c
	arm-none-eabi-gcc "$<" -mcpu=cortex-m4 -std=gnu11 -g3 -DSTM32 -DSTM32F4 -DSTM32F446RETx -DDEBUG -DNUCLEO_F446RE -c -I../Inc -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -MMD -MP -MF"Src/TP1_ex4_student.d" -MT"$@" --specs=nano.specs -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -o "$@"
